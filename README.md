...
- Bearer token is required by default. The server refuses to start without `CLAUDE_VOICE_TOKEN`.
- For local development only, you can bypass token enforcement with:
